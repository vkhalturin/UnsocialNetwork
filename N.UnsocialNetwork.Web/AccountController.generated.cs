...
namespace N.UnsocialNetwork.Web.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AccountController: N.UnsocialNetwork.Web.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult Login(N.UnsocialNetwork.Web.Models.LoginModel model, string returnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Login);
        ...
        public override System.Web.Mvc.ActionResult Register(N.UnsocialNetwork.Web.Models.RegisterModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult ChangePassword(N.UnsocialNetwork.Web.Models.ChangePasswordModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.ChangePassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }
